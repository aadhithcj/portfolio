        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[1.3fr_1fr]">
          <div className="nb-border nb-shadow-lg bg-foreground p-6 text-background md:p-8">
            ...
            <p className="mt-4 max-w-xl leading-relaxed text-background/75">
              {profile.summary} If you are working on something that needs an
              engineer who enjoys owning a product from concept to deployment, I
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-2">
              {[
                ...
                <span
                  key={color}
                  className="size-3 border-[2px] border-border"
